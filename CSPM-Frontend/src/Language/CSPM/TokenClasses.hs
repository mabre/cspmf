...
con_PrimToken_L_Newline = mkConstr ty_PrimToken "con_PrimToken_L_Newline" [] Prefix
con_PrimToken_T_WhiteSpace :: Constr
con_PrimToken_T_WhiteSpace = mkConstr ty_PrimToken "con_PrimToken_T_WhiteSpace" [] Prefix
con_PrimToken_L_LComment :: Constr
con_PrimToken_L_LComment = mkConstr ty_PrimToken "con_PrimToken_L_LComment" [] Prefix
con_PrimToken_L_BComment :: Constr
con_PrimToken_L_BComment = mkConstr ty_PrimToken "con_PrimToken_L_BComment" [] Prefix
con_PrimToken_L_Pragma :: Constr
con_PrimToken_L_Pragma = mkConstr ty_PrimToken "con_PrimToken_L_Pragma" [] Prefix
con_PrimToken_L_Include :: Constr
con_PrimToken_L_Include = mkConstr ty_PrimToken "con_PrimToken_L_Include" [] Prefix
con_PrimToken_L_EOF :: Constr
con_PrimToken_L_EOF = mkConstr ty_PrimToken "con_PrimToken_L_EOF" [] Prefix
con_PrimToken_L_Integer :: Constr
con_PrimToken_L_Integer = mkConstr ty_PrimToken "con_PrimToken_L_Integer" [] Prefix
con_PrimToken_L_String :: Constr
con_PrimToken_L_String = mkConstr ty_PrimToken "con_PrimToken_L_String" [] Prefix
con_PrimToken_L_Ident :: Constr
con_PrimToken_L_Ident = mkConstr ty_PrimToken "con_PrimToken_L_Ident" [] Prefix
con_PrimToken_T_channel :: Constr
con_PrimToken_T_channel = mkConstr ty_PrimToken "con_PrimToken_T_channel" [] Prefix
con_PrimToken_T_datatype :: Constr
con_PrimToken_T_datatype = mkConstr ty_PrimToken "con_PrimToken_T_datatype" [] Prefix
con_PrimToken_T_nametype :: Constr
con_PrimToken_T_nametype = mkConstr ty_PrimToken "con_PrimToken_T_nametype" [] Prefix
con_PrimToken_T_subtype :: Constr
con_PrimToken_T_subtype = mkConstr ty_PrimToken "con_PrimToken_T_subtype" [] Prefix
con_PrimToken_T_assert :: Constr
con_PrimToken_T_assert = mkConstr ty_PrimToken "con_PrimToken_T_assert" [] Prefix
con_PrimToken_T_pragma :: Constr
con_PrimToken_T_pragma = mkConstr ty_PrimToken "con_PrimToken_T_pragma" [] Prefix
con_PrimToken_T_transparent :: Constr
con_PrimToken_T_transparent = mkConstr ty_PrimToken "con_PrimToken_T_transparent" [] Prefix
con_PrimToken_T_external :: Constr
con_PrimToken_T_external = mkConstr ty_PrimToken "con_PrimToken_T_external" [] Prefix
con_PrimToken_T_print :: Constr
con_PrimToken_T_print = mkConstr ty_PrimToken "con_PrimToken_T_print" [] Prefix
con_PrimToken_T_if :: Constr
con_PrimToken_T_if = mkConstr ty_PrimToken "con_PrimToken_T_if" [] Prefix
con_PrimToken_T_then :: Constr
con_PrimToken_T_then = mkConstr ty_PrimToken "con_PrimToken_T_then" [] Prefix
con_PrimToken_T_else :: Constr
con_PrimToken_T_else = mkConstr ty_PrimToken "con_PrimToken_T_else" [] Prefix
con_PrimToken_T_let :: Constr
con_PrimToken_T_let = mkConstr ty_PrimToken "con_PrimToken_T_let" [] Prefix
con_PrimToken_T_within :: Constr
con_PrimToken_T_within = mkConstr ty_PrimToken "con_PrimToken_T_within" [] Prefix
con_PrimToken_T_true :: Constr
con_PrimToken_T_true = mkConstr ty_PrimToken "con_PrimToken_T_true" [] Prefix
con_PrimToken_T_false :: Constr
con_PrimToken_T_false = mkConstr ty_PrimToken "con_PrimToken_T_false" [] Prefix
con_PrimToken_T_not :: Constr
con_PrimToken_T_not = mkConstr ty_PrimToken "con_PrimToken_T_not" [] Prefix
con_PrimToken_T_and :: Constr
con_PrimToken_T_and = mkConstr ty_PrimToken "con_PrimToken_T_and" [] Prefix
con_PrimToken_T_or :: Constr
con_PrimToken_T_or = mkConstr ty_PrimToken "con_PrimToken_T_or" [] Prefix
con_PrimToken_T_STOP :: Constr
con_PrimToken_T_STOP = mkConstr ty_PrimToken "con_PrimToken_T_STOP" [] Prefix
con_PrimToken_T_SKIP :: Constr
con_PrimToken_T_SKIP = mkConstr ty_PrimToken "con_PrimToken_T_SKIP" [] Prefix
con_PrimToken_T_Events :: Constr
con_PrimToken_T_Events = mkConstr ty_PrimToken "con_PrimToken_T_Events" [] Prefix
con_PrimToken_T_Int :: Constr
con_PrimToken_T_Int = mkConstr ty_PrimToken "con_PrimToken_T_Int" [] Prefix
con_PrimToken_T_Bool :: Constr
con_PrimToken_T_Bool = mkConstr ty_PrimToken "con_PrimToken_T_Bool" [] Prefix
con_PrimToken_T_CHAOS :: Constr
con_PrimToken_T_CHAOS = mkConstr ty_PrimToken "con_PrimToken_T_CHAOS" [] Prefix
con_PrimToken_T_hat :: Constr
con_PrimToken_T_hat = mkConstr ty_PrimToken "con_PrimToken_T_hat" [] Prefix
con_PrimToken_T_hash :: Constr
con_PrimToken_T_hash = mkConstr ty_PrimToken "con_PrimToken_T_hash" [] Prefix
con_PrimToken_T_times :: Constr
con_PrimToken_T_times = mkConstr ty_PrimToken "con_PrimToken_T_times" [] Prefix
con_PrimToken_T_slash :: Constr
con_PrimToken_T_slash = mkConstr ty_PrimToken "con_PrimToken_T_slash" [] Prefix
con_PrimToken_T_percent :: Constr
con_PrimToken_T_percent = mkConstr ty_PrimToken "con_PrimToken_T_percent" [] Prefix
con_PrimToken_T_plus :: Constr
con_PrimToken_T_plus = mkConstr ty_PrimToken "con_PrimToken_T_plus" [] Prefix
con_PrimToken_T_minus :: Constr
con_PrimToken_T_minus = mkConstr ty_PrimToken "con_PrimToken_T_minus" [] Prefix
con_PrimToken_T_eq :: Constr
con_PrimToken_T_eq = mkConstr ty_PrimToken "con_PrimToken_T_eq" [] Prefix
con_PrimToken_T_neq :: Constr
con_PrimToken_T_neq = mkConstr ty_PrimToken "con_PrimToken_T_neq" [] Prefix
con_PrimToken_T_ge :: Constr
con_PrimToken_T_ge = mkConstr ty_PrimToken "con_PrimToken_T_ge" [] Prefix
con_PrimToken_T_le :: Constr
con_PrimToken_T_le = mkConstr ty_PrimToken "con_PrimToken_T_le" [] Prefix
con_PrimToken_T_lt :: Constr
con_PrimToken_T_lt = mkConstr ty_PrimToken "con_PrimToken_T_lt" [] Prefix
con_PrimToken_T_gt :: Constr
con_PrimToken_T_gt = mkConstr ty_PrimToken "con_PrimToken_T_gt" [] Prefix
con_PrimToken_T_amp :: Constr
con_PrimToken_T_amp = mkConstr ty_PrimToken "con_PrimToken_T_amp" [] Prefix
con_PrimToken_T_semicolon :: Constr
con_PrimToken_T_semicolon = mkConstr ty_PrimToken "con_PrimToken_T_semicolon" [] Prefix
con_PrimToken_T_comma :: Constr
con_PrimToken_T_comma = mkConstr ty_PrimToken "con_PrimToken_T_comma" [] Prefix
con_PrimToken_T_triangle :: Constr
con_PrimToken_T_triangle = mkConstr ty_PrimToken "con_PrimToken_T_triangle" [] Prefix
con_PrimToken_T_box :: Constr
con_PrimToken_T_box = mkConstr ty_PrimToken "con_PrimToken_T_box" [] Prefix
con_PrimToken_T_rhd :: Constr
con_PrimToken_T_rhd = mkConstr ty_PrimToken "con_PrimToken_T_rhd" [] Prefix
con_PrimToken_T_exp :: Constr
con_PrimToken_T_exp = mkConstr ty_PrimToken "con_PrimToken_T_exp" [] Prefix
con_PrimToken_T_sqcap :: Constr
con_PrimToken_T_sqcap = mkConstr ty_PrimToken "con_PrimToken_T_sqcap" [] Prefix
con_PrimToken_T_interleave :: Constr
con_PrimToken_T_interleave = mkConstr ty_PrimToken "con_PrimToken_T_interleave" [] Prefix
con_PrimToken_T_backslash :: Constr
con_PrimToken_T_backslash = mkConstr ty_PrimToken "con_PrimToken_T_backslash" [] Prefix
con_PrimToken_T_parallel :: Constr
con_PrimToken_T_parallel = mkConstr ty_PrimToken "con_PrimToken_T_parallel" [] Prefix
con_PrimToken_T_mid :: Constr
con_PrimToken_T_mid = mkConstr ty_PrimToken "con_PrimToken_T_mid" [] Prefix
con_PrimToken_T_at :: Constr
con_PrimToken_T_at = mkConstr ty_PrimToken "con_PrimToken_T_at" [] Prefix
con_PrimToken_T_atat :: Constr
con_PrimToken_T_atat = mkConstr ty_PrimToken "con_PrimToken_T_atat" [] Prefix
con_PrimToken_T_rightarrow :: Constr
con_PrimToken_T_rightarrow = mkConstr ty_PrimToken "con_PrimToken_T_rightarrow" [] Prefix
con_PrimToken_T_leftarrow :: Constr
con_PrimToken_T_leftarrow = mkConstr ty_PrimToken "con_PrimToken_T_leftarrow" [] Prefix
con_PrimToken_T_leftrightarrow :: Constr
con_PrimToken_T_leftrightarrow = mkConstr ty_PrimToken "con_PrimToken_T_leftrightarrow" [] Prefix
con_PrimToken_T_dot :: Constr
con_PrimToken_T_dot = mkConstr ty_PrimToken "con_PrimToken_T_dot" [] Prefix
con_PrimToken_T_dotdot :: Constr
con_PrimToken_T_dotdot = mkConstr ty_PrimToken "con_PrimToken_T_dotdot" [] Prefix
con_PrimToken_T_exclamation :: Constr
con_PrimToken_T_exclamation = mkConstr ty_PrimToken "con_PrimToken_T_exclamation" [] Prefix
con_PrimToken_T_questionmark :: Constr
con_PrimToken_T_questionmark = mkConstr ty_PrimToken "con_PrimToken_T_questionmark" [] Prefix
con_PrimToken_T_colon :: Constr
con_PrimToken_T_colon = mkConstr ty_PrimToken "con_PrimToken_T_colon" [] Prefix
con_PrimToken_T_openParen :: Constr
con_PrimToken_T_openParen = mkConstr ty_PrimToken "con_PrimToken_T_openParen" [] Prefix
con_PrimToken_T_closeParen :: Constr
con_PrimToken_T_closeParen = mkConstr ty_PrimToken "con_PrimToken_T_closeParen" [] Prefix
con_PrimToken_T_openBrace :: Constr
con_PrimToken_T_openBrace = mkConstr ty_PrimToken "con_PrimToken_T_openBrace" [] Prefix
con_PrimToken_T_closeBrace :: Constr
con_PrimToken_T_closeBrace = mkConstr ty_PrimToken "con_PrimToken_T_closeBrace" [] Prefix
con_PrimToken_T_openBrack :: Constr
con_PrimToken_T_openBrack = mkConstr ty_PrimToken "con_PrimToken_T_openBrack" [] Prefix
con_PrimToken_T_closeBrack :: Constr
con_PrimToken_T_closeBrack = mkConstr ty_PrimToken "con_PrimToken_T_closeBrack" [] Prefix
con_PrimToken_T_openAssertBrack :: Constr
con_PrimToken_T_openAssertBrack = mkConstr ty_PrimToken "con_PrimToken_T_openAssertBrack" [] Prefix
con_PrimToken_T_closeAssertBrack :: Constr
con_PrimToken_T_closeAssertBrack = mkConstr ty_PrimToken "con_PrimToken_T_closeAssertBrack" [] Prefix
con_PrimToken_T_closeSpecialBrack :: Constr
con_PrimToken_T_closeSpecialBrack = mkConstr ty_PrimToken "con_PrimToken_T_closeSpecialBrack" [] Prefix
con_PrimToken_T_openOxBrack :: Constr
con_PrimToken_T_openOxBrack = mkConstr ty_PrimToken "con_PrimToken_T_openOxBrack" [] Prefix
con_PrimToken_T_closeOxBrack :: Constr
con_PrimToken_T_closeOxBrack = mkConstr ty_PrimToken "con_PrimToken_T_closeOxBrack" [] Prefix
con_PrimToken_T_openBrackBrack :: Constr
con_PrimToken_T_openBrackBrack = mkConstr ty_PrimToken "con_PrimToken_T_openBrackBrack" [] Prefix
con_PrimToken_T_closeBrackBrack :: Constr
con_PrimToken_T_closeBrackBrack = mkConstr ty_PrimToken "con_PrimToken_T_closeBrackBrack" [] Prefix
con_PrimToken_T_openPBrace :: Constr
con_PrimToken_T_openPBrace = mkConstr ty_PrimToken "con_PrimToken_T_openPBrace" [] Prefix
con_PrimToken_T_closePBrace :: Constr
con_PrimToken_T_closePBrace = mkConstr ty_PrimToken "con_PrimToken_T_closePBrace" [] Prefix
con_PrimToken_T_underscore :: Constr
con_PrimToken_T_underscore = mkConstr ty_PrimToken "con_PrimToken_T_underscore" [] Prefix
con_PrimToken_T_is :: Constr
con_PrimToken_T_is = mkConstr ty_PrimToken "con_PrimToken_T_is" [] Prefix
con_PrimToken_T_Refine :: Constr
con_PrimToken_T_Refine = mkConstr ty_PrimToken "con_PrimToken_T_Refine" [] Prefix
con_PrimToken_T_trace :: Constr
con_PrimToken_T_trace = mkConstr ty_PrimToken "con_PrimToken_T_trace" [] Prefix
con_PrimToken_T_failure :: Constr
con_PrimToken_T_failure = mkConstr ty_PrimToken "con_PrimToken_T_failure" [] Prefix
con_PrimToken_T_failureDivergence :: Constr
con_PrimToken_T_failureDivergence = mkConstr ty_PrimToken "con_PrimToken_T_failureDivergence" [] Prefix
con_PrimToken_T_refusalTesting :: Constr
con_PrimToken_T_refusalTesting = mkConstr ty_PrimToken "con_PrimToken_T_refusalTesting" [] Prefix
con_PrimToken_T_refusalTestingDiv :: Constr
con_PrimToken_T_refusalTestingDiv = mkConstr ty_PrimToken "con_PrimToken_T_refusalTestingDiv" [] Prefix
con_PrimToken_T_revivalTesting :: Constr
con_PrimToken_T_revivalTesting = mkConstr ty_PrimToken "con_PrimToken_T_revivalTesting" [] Prefix
con_PrimToken_T_revivalTestingDiv :: Constr
con_PrimToken_T_revivalTestingDiv = mkConstr ty_PrimToken "con_PrimToken_T_revivalTestingDiv" [] Prefix
con_PrimToken_T_tauPriorityOp :: Constr
con_PrimToken_T_tauPriorityOp = mkConstr ty_PrimToken "con_PrimToken_T_tauPriorityOp" [] Prefix
con_PrimToken_T_model_check :: Constr
con_PrimToken_T_model_check = mkConstr ty_PrimToken "con_PrimToken_T_model_check" [] Prefix
con_PrimToken_T_tau :: Constr
con_PrimToken_T_tau = mkConstr ty_PrimToken "con_PrimToken_T_tau" [] Prefix
con_PrimToken_T_priority :: Constr
con_PrimToken_T_priority = mkConstr ty_PrimToken "con_PrimToken_T_priority" [] Prefix
con_PrimToken_T_over :: Constr
con_PrimToken_T_over = mkConstr ty_PrimToken "con_PrimToken_T_over" [] Prefix
con_PrimToken_T_deadlock :: Constr
con_PrimToken_T_deadlock = mkConstr ty_PrimToken "con_PrimToken_T_deadlock" [] Prefix
con_PrimToken_T_deterministic :: Constr
con_PrimToken_T_deterministic = mkConstr ty_PrimToken "con_PrimToken_T_deterministic" [] Prefix
con_PrimToken_T_livelock :: Constr
con_PrimToken_T_livelock = mkConstr ty_PrimToken "con_PrimToken_T_livelock" [] Prefix
con_PrimToken_T_free :: Constr
con_PrimToken_T_free = mkConstr ty_PrimToken "con_PrimToken_T_free" [] Prefix
con_PrimToken_T_F :: Constr
con_PrimToken_T_F = mkConstr ty_PrimToken "con_PrimToken_T_F" [] Prefix
con_PrimToken_T_T :: Constr
con_PrimToken_T_T = mkConstr ty_PrimToken "con_PrimToken_T_T" [] Prefix
con_PrimToken_T_FD :: Constr
con_PrimToken_T_FD = mkConstr ty_PrimToken "con_PrimToken_T_FD" [] Prefix
con_PrimToken_T_LTL :: Constr
con_PrimToken_T_LTL = mkConstr ty_PrimToken "con_PrimToken_T_LTL" [] Prefix
con_PrimToken_T_CTL :: Constr
con_PrimToken_T_CTL = mkConstr ty_PrimToken "con_PrimToken_T_CTL" [] Prefix
